...
package body Auto_Counters_Suite.BR_Flyweights_Tests is
   ...
   function Name (T : BR_Flyweights_Test) return Test_String is
      pragma Unreferenced (T);
   begin
      return Format ("Tests of Basic_Refcounted_Flyweights package functionality");
   end Name;
   ...
   procedure Set_Up (T : in out BR_Flyweights_Test) is
   begin
      null;
   end Set_Up;
   ...
   procedure Check_Refs_Usage (T : in out Test_Cases.Test_Case'Class) is
      pragma Unreferenced(T);
