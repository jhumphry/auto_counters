...
package Auto_Counters_Suite.Refcount_Flyweights_Tests is

   type Refcount_Flyweights_Test is new Test_Cases.Test_Case with null record;

   procedure Register_Tests (T: in out Refcount_Flyweights_Test);

   function Name (T : Refcount_Flyweights_Test) return Test_String;

   procedure Set_Up (T : in out Refcount_Flyweights_Test);
